...
var canvas_inline_default = 'function ne(){let p=document.querySelectorAll(".canvas-container");if(p.length!==0)for(let t of Array.from(p)){if(t.dataset.initialized==="true")continue;t.dataset.initialized="true";let y=t.querySelector(".canvas-viewport");if(!y)continue;let Q=t.dataset.enableInteraction!=="false",w=parseFloat(t.dataset.minZoom??"")||.1,S=parseFloat(t.dataset.maxZoom??"")||5,s=parseFloat(t.dataset.initialZoom??"")||1,l=0,a=0,H=!1,R=0,P=0,m=()=>{y.style.transform=`translate(${l}px, ${a}px) scale(${s})`},b=()=>{let n=t.getBoundingClientRect(),c=parseFloat(y.style.width)||1e3,u=parseFloat(y.style.height)||1e3,i=n.width/c,v=n.height/u;s=Math.min(i,v,1)*.9,s=Math.max(w,Math.min(S,s)),l=(n.width-c*s)/2,a=(n.height-u*s)/2,m()};b();let X=s,Y=l,I=a,g=t.querySelector(".canvas-reset-view"),d=()=>{if(!g)return;let n=Math.abs(s-X)>.001||Math.abs(l-Y)>1||Math.abs(a-I)>1;g.style.display=n?"flex":"none"},B=(n,c,u)=>{let i=s;s=Math.max(w,Math.min(S,s*n)),l=c-(c-l)*(s/i),a=u-(u-a)*(s/i),m(),d()},f=[];if(Q){let u=e=>e.deltaMode!==0?e.deltaY>0?.8333333333333334:1.2:Math.exp(-e.deltaY*.0025),i=e=>e.deltaMode!==0?!1:e.deltaX!==0||!Number.isInteger(e.deltaY)?!0:Math.abs(e.deltaY)<40,v=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?!(e.scrollWidth<=e.clientWidth||e.scrollLeft<=0&&o.deltaX<0||e.scrollLeft+e.clientWidth>=e.scrollWidth-1&&o.deltaX>0):!(e.scrollHeight<=e.clientHeight||e.scrollTop<=0&&o.deltaY<0||e.scrollTop+e.clientHeight>=e.scrollHeight-1&&o.deltaY>0),M=e=>{let o=t.getBoundingClientRect(),r=e.clientX-o.left,T=e.clientY-o.top;if(e.ctrlKey||e.metaKey){e.preventDefault(),B(u(e),r,T);return}let h=e.target instanceof HTMLElement?e.target.closest(".canvas-node:not(.canvas-node-group)"):null;if(h){let E=h.querySelector(".canvas-node-content");if(E instanceof HTMLElement&&v(E,e))return;e.preventDefault();return}e.preventDefault(),i(e)?(l-=e.deltaX,a-=e.deltaY,m(),d()):B(u(e),r,T)},_=e=>{if(e.button===0&&!(e.target instanceof HTMLElement&&(e.target.closest("a")||e.target.closest("button")))){if(e.target instanceof HTMLElement){let o=e.target.closest(".canvas-node-content");if(o&&o.scrollHeight>o.clientHeight){let r=o.getBoundingClientRect();if(e.clientX>=r.right-16)return}}H=!0,R=e.clientX-l,P=e.clientY-a,t.setPointerCapture(e.pointerId)}},A=e=>{H&&(l=e.clientX-R,a=e.clientY-P,m(),d())},D=()=>{H=!1};t.addEventListener("wheel",M,{passive:!1}),t.addEventListener("pointerdown",_),t.addEventListener("pointermove",A),t.addEventListener("pointerup",D);let W=0,C=0,O=0,k=!1,N=e=>{if(e.length<2||!e[0]||!e[1])return 0;let o=e[0].clientX-e[1].clientX,r=e[0].clientY-e[1].clientY;return Math.sqrt(o*o+r*r)},V=e=>{if(e.touches.length===2){let o=e.touches[0],r=e.touches[1];if(!o||!r)return;e.preventDefault(),k=!0,H=!1,W=N(e.touches),C=(o.clientX+r.clientX)/2,O=(o.clientY+r.clientY)/2}},$=e=>{if(e.touches.length===2&&k){let o=e.touches[0],r=e.touches[1];if(!o||!r)return;e.preventDefault();let T=N(e.touches),h=(o.clientX+r.clientX)/2,E=(o.clientY+r.clientY)/2,U=t.getBoundingClientRect(),j=h-U.left,G=E-U.top,te=T/W,J=s;s=Math.max(w,Math.min(S,s*te)),l=j-(j-l)*(s/J),a=G-(G-a)*(s/J),l+=h-C,a+=E-O,W=T,C=h,O=E,m(),d()}},K=e=>{e.touches.length<2&&(k=!1)};t.addEventListener("touchstart",V,{passive:!1}),t.addEventListener("touchmove",$,{passive:!1}),t.addEventListener("touchend",K),f.push(()=>{t.removeEventListener("wheel",M),t.removeEventListener("pointerdown",_),t.removeEventListener("pointermove",A),t.removeEventListener("pointerup",D),t.removeEventListener("touchstart",V),t.removeEventListener("touchmove",$),t.removeEventListener("touchend",K)})}let F=t.closest(\'.page[data-frame="canvas"]\'),q=F?.querySelector(".canvas-sidebar-toggle");if(F&&q){let n=()=>{let c=t.getBoundingClientRect();F.classList.toggle("canvas-sidebar-open"),requestAnimationFrame(()=>{let i=t.getBoundingClientRect().left-c.left;l+=i,Y+=i,m(),d()})};q.addEventListener("click",n),f.push(()=>{q.removeEventListener("click",n)})}let Z=t.querySelector(".canvas-zoom-in"),x=t.querySelector(".canvas-zoom-out"),z=n=>{let c=t.getBoundingClientRect();B(n,c.width/2,c.height/2)};if(Z){let n=()=>{z(1.25)};Z.addEventListener("click",n),f.push(()=>Z.removeEventListener("click",n))}if(x){let n=()=>{z(.8)};x.addEventListener("click",n),f.push(()=>x.removeEventListener("click",n))}if(g){let n=()=>{b(),X=s,Y=l,I=a,d()};g.addEventListener("click",n),f.push(()=>g.removeEventListener("click",n))}let L=t.querySelector(".canvas-fullscreen-toggle");if(L){let n=L.querySelector(".canvas-fullscreen-enter"),c=L.querySelector(".canvas-fullscreen-exit"),u=()=>{let M=document.fullscreenElement===t;n&&(n.style.display=M?"none":""),c&&(c.style.display=M?"":"none")},i=()=>{document.fullscreenElement===t?document.exitFullscreen():t.requestFullscreen()},v=()=>{u(),requestAnimationFrame(()=>{b(),X=s,Y=l,I=a,d()})};L.addEventListener("click",i),document.addEventListener("fullscreenchange",v),f.push(()=>{L.removeEventListener("click",i),document.removeEventListener("fullscreenchange",v)})}let ee=t.querySelectorAll(".canvas-iframe-wrapper iframe");for(let n of Array.from(ee))n.addEventListener("error",()=>{let c=n.parentElement?.querySelector(".canvas-iframe-fallback");c&&(n.style.display="none",c.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let n of f)n();t.dataset.initialized="false"})}}if(typeof document<"u"){let p=()=>{ne()};document.addEventListener("nav",p),document.addEventListener("render",p)}\n';
var l;
