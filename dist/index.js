...
var canvas_inline_default = 'function de(){let T=document.querySelectorAll(".canvas-container");if(T.length!==0)for(let t of Array.from(T)){if(t.dataset.initialized==="true")continue;t.dataset.initialized="true";let b=t.querySelector(".canvas-viewport");if(!b)continue;let ae=t.dataset.enableInteraction!=="false",ce=t.dataset.defaultFullscreen==="true",h=t.closest(\'.page[data-frame="canvas"]\'),le=window.matchMedia("(max-width: 800px)").matches;h&&!ce&&!le&&(h.classList.add("canvas-init-no-transition","canvas-sidebar-open"),h.offsetWidth,requestAnimationFrame(()=>{h.classList.remove("canvas-init-no-transition")}));let F=parseFloat(t.dataset.minZoom??"")||.1,X=parseFloat(t.dataset.maxZoom??"")||5,o=parseFloat(t.dataset.initialZoom??"")||1,d=o,q=0,I=0,f=0,l=0,r=0,w=!1,_=0,D=0,g=()=>{b.style.transform=`translate(${l}px, ${r}px) scale(${o})`},W=()=>{let n=t.getBoundingClientRect(),c=parseFloat(b.style.width)||1e3,i=parseFloat(b.style.height)||1e3,u=n.width/c,L=n.height/i;o=Math.min(u,L,1)*.9,o=Math.max(F,Math.min(X,o)),l=(n.width-c*o)/2,r=(n.height-i*o)/2,d=o,f&&(cancelAnimationFrame(f),f=0),g()};W();let Z=o,Y=l,x=r,y=t.querySelector(".canvas-reset-view"),v=()=>{if(!y)return;let n=Math.abs(o-Z)>.001||Math.abs(l-Y)>1||Math.abs(r-x)>1;y.style.display=n?"flex":"none"},re=.2,N=()=>{let n=o;o+=(d-o)*re,Math.abs(d-o)<5e-4&&(o=d),l=q-(q-l)*(o/n),r=I-(I-r)*(o/n),g(),v(),f=o===d?0:requestAnimationFrame(N)},O=(n,c,i)=>{d=Math.max(F,Math.min(X,d*n)),q=c,I=i,f||(f=requestAnimationFrame(N))},m=[];if(ae){let i=e=>e.deltaMode!==0?e.deltaY>0?.7692307692307692:1.3:Math.exp(-e.deltaY*.004),u=e=>e.deltaMode!==0?!1:e.deltaX!==0||!Number.isInteger(e.deltaY)?!0:Math.abs(e.deltaY)<40,L=(e,s)=>Math.abs(s.deltaX)>Math.abs(s.deltaY)?e.scrollWidth>e.clientWidth:e.scrollHeight>e.clientHeight,S=(e,s)=>Math.abs(s.deltaX)>Math.abs(s.deltaY)?!(e.scrollWidth<=e.clientWidth||e.scrollLeft<=0&&s.deltaX<0||e.scrollLeft+e.clientWidth>=e.scrollWidth-1&&s.deltaX>0):!(e.scrollHeight<=e.clientHeight||e.scrollTop<=0&&s.deltaY<0||e.scrollTop+e.clientHeight>=e.scrollHeight-1&&s.deltaY>0),$=e=>{let s=t.getBoundingClientRect(),a=e.clientX-s.left,E=e.clientY-s.top;if(e.ctrlKey||e.metaKey){e.preventDefault(),O(i(e),a,E);return}let M=e.target instanceof HTMLElement?e.target.closest(".canvas-node:not(.canvas-node-group)"):null;if(M){let p=M.querySelector(".canvas-node-content");if(p instanceof HTMLElement&&L(p,e)){if(S(p,e))return;e.preventDefault();return}}e.preventDefault(),u(e)?(l-=e.deltaX,r-=e.deltaY,g(),v()):O(i(e),a,E)},K=e=>{let s=e.button===1;if(!(e.button!==0&&!s)){if(s)e.preventDefault();else if(e.target instanceof HTMLElement){if(e.target.closest("a")||e.target.closest("button"))return;let a=e.target.closest(".canvas-node-content");if(a&&a.scrollHeight>a.clientHeight){let E=a.getBoundingClientRect();if(e.clientX>=E.right-16)return}}w=!0,_=e.clientX-l,D=e.clientY-r,t.style.cursor="grabbing",t.setPointerCapture(e.pointerId)}},G=e=>{w&&(l=e.clientX-_,r=e.clientY-D,g(),v())},U=()=>{w=!1,t.style.cursor=""};t.addEventListener("wheel",$,{passive:!1}),t.addEventListener("pointerdown",K),t.addEventListener("pointermove",G),t.addEventListener("pointerup",U);let C=0,R=0,k=0,P=!1,j=e=>{if(e.length<2||!e[0]||!e[1])return 0;let s=e[0].clientX-e[1].clientX,a=e[0].clientY-e[1].clientY;return Math.sqrt(s*s+a*a)},J=e=>{if(e.touches.length===2){let s=e.touches[0],a=e.touches[1];if(!s||!a)return;e.preventDefault(),P=!0,w=!1,C=j(e.touches),R=(s.clientX+a.clientX)/2,k=(s.clientY+a.clientY)/2}},Q=e=>{if(e.touches.length===2&&P){let s=e.touches[0],a=e.touches[1];if(!s||!a)return;e.preventDefault();let E=j(e.touches),M=(s.clientX+a.clientX)/2,p=(s.clientY+a.clientY)/2,te=t.getBoundingClientRect(),ne=M-te.left,oe=p-te.top,ue=E/C,se=o;o=Math.max(F,Math.min(X,o*ue)),d=o,l=ne-(ne-l)*(o/se),r=oe-(oe-r)*(o/se),l+=M-R,r+=p-k,C=E,R=M,k=p,g(),v()}},ee=e=>{e.touches.length<2&&(P=!1)};t.addEventListener("touchstart",J,{passive:!1}),t.addEventListener("touchmove",Q,{passive:!1}),t.addEventListener("touchend",ee),m.push(()=>{t.removeEventListener("wheel",$),t.removeEventListener("pointerdown",K),t.removeEventListener("pointermove",G),t.removeEventListener("pointerup",U),t.removeEventListener("touchstart",J),t.removeEventListener("touchmove",Q),t.removeEventListener("touchend",ee)})}let B=h?.querySelector(".canvas-sidebar-toggle");if(h&&B){let n=()=>{let c=t.getBoundingClientRect();h.classList.toggle("canvas-sidebar-open"),requestAnimationFrame(()=>{let u=t.getBoundingClientRect().left-c.left;l+=u,Y+=u,g(),v()})};B.addEventListener("click",n),m.push(()=>{B.removeEventListener("click",n)})}let A=t.querySelector(".canvas-zoom-in"),z=t.querySelector(".canvas-zoom-out"),V=n=>{let c=t.getBoundingClientRect();O(n,c.width/2,c.height/2)};if(m.push(()=>{f&&cancelAnimationFrame(f)}),A){let n=()=>{V(1.25)};A.addEventListener("click",n),m.push(()=>A.removeEventListener("click",n))}if(z){let n=()=>{V(.8)};z.addEventListener("click",n),m.push(()=>z.removeEventListener("click",n))}if(y){let n=()=>{W(),Z=o,Y=l,x=r,v()};y.addEventListener("click",n),m.push(()=>y.removeEventListener("click",n))}let H=t.querySelector(".canvas-fullscreen-toggle");if(H){let n=H.querySelector(".canvas-fullscreen-enter"),c=H.querySelector(".canvas-fullscreen-exit"),i=()=>{let S=document.fullscreenElement===t;n&&(n.style.display=S?"none":""),c&&(c.style.display=S?"":"none")},u=()=>{document.fullscreenElement===t?document.exitFullscreen():t.requestFullscreen()},L=()=>{i(),requestAnimationFrame(()=>{W(),Z=o,Y=l,x=r,v()})};H.addEventListener("click",u),document.addEventListener("fullscreenchange",L),m.push(()=>{H.removeEventListener("click",u),document.removeEventListener("fullscreenchange",L)})}let ie=t.querySelectorAll(".canvas-iframe-wrapper iframe");for(let n of Array.from(ie))n.addEventListener("error",()=>{let c=n.parentElement?.querySelector(".canvas-iframe-fallback");c&&(n.style.display="none",c.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let n of m)n();t.dataset.initialized="false"})}}if(typeof document<"u"){let T=()=>{de()};document.addEventListener("nav",T),document.addEventListener("render",T)}\n';
var l;
