...
var canvas_inline_default = 'function de(){let M=document.querySelectorAll(".canvas-container");if(M.length!==0)for(let t of Array.from(M)){if(t.dataset.initialized==="true")continue;t.dataset.initialized="true";let w=t.querySelector(".canvas-viewport");if(!w)continue;let ae=t.dataset.enableInteraction!=="false",ce=t.dataset.defaultFullscreen==="true",h=t.closest(\'.page[data-frame="canvas"]\'),le=window.matchMedia("(max-width: 800px)").matches;h&&!ce&&!le&&(h.classList.add("canvas-init-no-transition","canvas-sidebar-open"),h.offsetWidth,requestAnimationFrame(()=>{h.classList.remove("canvas-init-no-transition")}));let F=parseFloat(t.dataset.minZoom??"")||.1,X=parseFloat(t.dataset.maxZoom??"")||5,s=parseFloat(t.dataset.initialZoom??"")||1,d=s,q=0,I=0,f=0,c=0,i=0,b=!1,_=0,D=0,p=()=>{w.style.transform=`translate(${c}px, ${i}px) scale(${s})`},W=()=>{let n=t.getBoundingClientRect(),a=parseFloat(w.style.width)||1e3,r=parseFloat(w.style.height)||1e3,u=n.width/a,g=n.height/r;s=Math.min(u,g,1)*.9,s=Math.max(F,Math.min(X,s)),c=(n.width-a*s)/2,i=(n.height-r*s)/2,d=s,f&&(cancelAnimationFrame(f),f=0),p()};W();let Z=s,Y=c,x=i,T=t.querySelector(".canvas-reset-view"),v=()=>{if(!T)return;let n=Math.abs(s-Z)>.001||Math.abs(c-Y)>1||Math.abs(i-x)>1;T.style.display=n?"flex":"none"},ie=.2,N=()=>{let n=s;s+=(d-s)*ie,Math.abs(d-s)<5e-4&&(s=d),c=q-(q-c)*(s/n),i=I-(I-i)*(s/n),p(),v(),f=s===d?0:requestAnimationFrame(N)},O=(n,a,r)=>{d=Math.max(F,Math.min(X,d*n)),q=a,I=r,f||(f=requestAnimationFrame(N))},m=[];if(ae){let r=e=>e.deltaMode!==0?e.deltaY>0?.7692307692307692:1.3:Math.exp(-e.deltaY*.004),u=e=>e.deltaMode!==0?!1:e.deltaX!==0||!Number.isInteger(e.deltaY)?!0:Math.abs(e.deltaY)<40,g=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?e.scrollWidth>e.clientWidth:e.scrollHeight>e.clientHeight,S=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?!(e.scrollWidth<=e.clientWidth||e.scrollLeft<=0&&o.deltaX<0||e.scrollLeft+e.clientWidth>=e.scrollWidth-1&&o.deltaX>0):!(e.scrollHeight<=e.clientHeight||e.scrollTop<=0&&o.deltaY<0||e.scrollTop+e.clientHeight>=e.scrollHeight-1&&o.deltaY>0),$=e=>{let o=t.getBoundingClientRect(),l=e.clientX-o.left,H=e.clientY-o.top;if(e.ctrlKey||e.metaKey){e.preventDefault(),O(r(e),l,H);return}let L=e.target instanceof HTMLElement?e.target.closest(".canvas-node:not(.canvas-node-group)"):null;if(L){let E=L.querySelector(".canvas-node-content");if(E instanceof HTMLElement&&g(E,e)){if(S(E,e))return;e.preventDefault();return}}e.preventDefault(),u(e)?(c-=e.deltaX,i-=e.deltaY,p(),v()):O(r(e),l,H)},K=e=>{if(e.button===0&&!(e.target instanceof HTMLElement&&(e.target.closest("a")||e.target.closest("button")))){if(e.target instanceof HTMLElement){let o=e.target.closest(".canvas-node-content");if(o&&o.scrollHeight>o.clientHeight){let l=o.getBoundingClientRect();if(e.clientX>=l.right-16)return}}b=!0,_=e.clientX-c,D=e.clientY-i,t.setPointerCapture(e.pointerId)}},G=e=>{b&&(c=e.clientX-_,i=e.clientY-D,p(),v())},U=()=>{b=!1};t.addEventListener("wheel",$,{passive:!1}),t.addEventListener("pointerdown",K),t.addEventListener("pointermove",G),t.addEventListener("pointerup",U);let C=0,R=0,k=0,P=!1,j=e=>{if(e.length<2||!e[0]||!e[1])return 0;let o=e[0].clientX-e[1].clientX,l=e[0].clientY-e[1].clientY;return Math.sqrt(o*o+l*l)},J=e=>{if(e.touches.length===2){let o=e.touches[0],l=e.touches[1];if(!o||!l)return;e.preventDefault(),P=!0,b=!1,C=j(e.touches),R=(o.clientX+l.clientX)/2,k=(o.clientY+l.clientY)/2}},Q=e=>{if(e.touches.length===2&&P){let o=e.touches[0],l=e.touches[1];if(!o||!l)return;e.preventDefault();let H=j(e.touches),L=(o.clientX+l.clientX)/2,E=(o.clientY+l.clientY)/2,te=t.getBoundingClientRect(),ne=L-te.left,oe=E-te.top,ue=H/C,se=s;s=Math.max(F,Math.min(X,s*ue)),d=s,c=ne-(ne-c)*(s/se),i=oe-(oe-i)*(s/se),c+=L-R,i+=E-k,C=H,R=L,k=E,p(),v()}},ee=e=>{e.touches.length<2&&(P=!1)};t.addEventListener("touchstart",J,{passive:!1}),t.addEventListener("touchmove",Q,{passive:!1}),t.addEventListener("touchend",ee),m.push(()=>{t.removeEventListener("wheel",$),t.removeEventListener("pointerdown",K),t.removeEventListener("pointermove",G),t.removeEventListener("pointerup",U),t.removeEventListener("touchstart",J),t.removeEventListener("touchmove",Q),t.removeEventListener("touchend",ee)})}let B=h?.querySelector(".canvas-sidebar-toggle");if(h&&B){let n=()=>{let a=t.getBoundingClientRect();h.classList.toggle("canvas-sidebar-open"),requestAnimationFrame(()=>{let u=t.getBoundingClientRect().left-a.left;c+=u,Y+=u,p(),v()})};B.addEventListener("click",n),m.push(()=>{B.removeEventListener("click",n)})}let A=t.querySelector(".canvas-zoom-in"),z=t.querySelector(".canvas-zoom-out"),V=n=>{let a=t.getBoundingClientRect();O(n,a.width/2,a.height/2)};if(m.push(()=>{f&&cancelAnimationFrame(f)}),A){let n=()=>{V(1.25)};A.addEventListener("click",n),m.push(()=>A.removeEventListener("click",n))}if(z){let n=()=>{V(.8)};z.addEventListener("click",n),m.push(()=>z.removeEventListener("click",n))}if(T){let n=()=>{W(),Z=s,Y=c,x=i,v()};T.addEventListener("click",n),m.push(()=>T.removeEventListener("click",n))}let y=t.querySelector(".canvas-fullscreen-toggle");if(y){let n=y.querySelector(".canvas-fullscreen-enter"),a=y.querySelector(".canvas-fullscreen-exit"),r=()=>{let S=document.fullscreenElement===t;n&&(n.style.display=S?"none":""),a&&(a.style.display=S?"":"none")},u=()=>{document.fullscreenElement===t?document.exitFullscreen():t.requestFullscreen()},g=()=>{r(),requestAnimationFrame(()=>{W(),Z=s,Y=c,x=i,v()})};y.addEventListener("click",u),document.addEventListener("fullscreenchange",g),m.push(()=>{y.removeEventListener("click",u),document.removeEventListener("fullscreenchange",g)})}let re=t.querySelectorAll(".canvas-iframe-wrapper iframe");for(let n of Array.from(re))n.addEventListener("error",()=>{let a=n.parentElement?.querySelector(".canvas-iframe-fallback");a&&(n.style.display="none",a.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let n of m)n();t.dataset.initialized="false"})}}if(typeof document<"u"){let M=()=>{de()};document.addEventListener("nav",M),document.addEventListener("render",M)}\n';
var l;
