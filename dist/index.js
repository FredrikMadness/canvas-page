...
var canvas_inline_default = 'function fe(){let T=document.querySelectorAll(".canvas-container");if(T.length!==0)for(let t of Array.from(T)){if(t.dataset.initialized==="true")continue;t.dataset.initialized="true";let b=t.querySelector(".canvas-viewport");if(!b)continue;let re=t.dataset.enableInteraction!=="false",ce=t.dataset.defaultFullscreen==="true",v=t.closest(\'.page[data-frame="canvas"]\'),le=window.matchMedia("(max-width: 800px)").matches;v&&!ce&&!le&&(v.classList.add("canvas-init-no-transition","canvas-sidebar-open"),v.offsetWidth,requestAnimationFrame(()=>{v.classList.remove("canvas-init-no-transition")}));let F=parseFloat(t.dataset.minZoom??"")||.1,X=parseFloat(t.dataset.maxZoom??"")||5,o=parseFloat(t.dataset.initialZoom??"")||1,d=o,q=0,I=0,f=0,c=0,l=0,w=!1,P=0,_=0,g=()=>{b.style.transform=`translate(${c}px, ${l}px) scale(${o})`},W=()=>{let n=t.getBoundingClientRect(),r=parseFloat(b.style.width)||1e3,i=parseFloat(b.style.height)||1e3,u=n.width/r,L=n.height/i;o=Math.min(u,L,1)*.9,o=Math.max(F,Math.min(X,o)),c=(n.width-r*o)/2,l=(n.height-i*o)/2,d=o,f&&(cancelAnimationFrame(f),f=0),g()};W();let Z=o,Y=c,x=l,y=t.querySelector(".canvas-reset-view"),h=()=>{if(!y)return;let n=Math.abs(o-Z)>.001||Math.abs(c-Y)>1||Math.abs(l-x)>1;y.style.display=n?"flex":"none"},ie=.2,N=()=>{let n=o;o+=(d-o)*ie,Math.abs(d-o)<5e-4&&(o=d),c=q-(q-c)*(o/n),l=I-(I-l)*(o/n),g(),h(),f=o===d?0:requestAnimationFrame(N)},O=(n,r,i)=>{d=Math.max(F,Math.min(X,d*n)),q=r,I=i,f||(f=requestAnimationFrame(N))},m=[];if(re){let i=e=>e.deltaMode!==0?e.deltaY>0?.7692307692307692:1.3:Math.exp(-e.deltaY*.004),u=e=>e.deltaMode!==0?!1:e.deltaX!==0||!Number.isInteger(e.deltaY)?!0:Math.abs(e.deltaY)<40,L=(e,s)=>Math.abs(s.deltaX)>Math.abs(s.deltaY)?e.scrollWidth>e.clientWidth:e.scrollHeight>e.clientHeight,S=(e,s)=>Math.abs(s.deltaX)>Math.abs(s.deltaY)?!(e.scrollWidth<=e.clientWidth||e.scrollLeft<=0&&s.deltaX<0||e.scrollLeft+e.clientWidth>=e.scrollWidth-1&&s.deltaX>0):!(e.scrollHeight<=e.clientHeight||e.scrollTop<=0&&s.deltaY<0||e.scrollTop+e.clientHeight>=e.scrollHeight-1&&s.deltaY>0),$=e=>{let s=t.getBoundingClientRect(),a=e.clientX-s.left,E=e.clientY-s.top;if(e.ctrlKey||e.metaKey){e.preventDefault(),O(i(e),a,E);return}let M=e.target instanceof HTMLElement?e.target.closest(".canvas-node:not(.canvas-node-group)"):null;if(M){let p=M.querySelector(".canvas-node-content");if(p instanceof HTMLElement&&L(p,e)){if(S(p,e))return;e.preventDefault();return}}e.preventDefault(),u(e)?(c-=e.deltaX,l-=e.deltaY,g(),h()):O(i(e),a,E)},K=e=>{let s=e.button===1;if(!(e.button!==0&&!s)){if(s)e.preventDefault();else if(e.target instanceof HTMLElement){if(e.target.closest("a")||e.target.closest("button"))return;let a=e.target.closest(".canvas-node-content");if(a&&a.scrollHeight>a.clientHeight){let E=a.getBoundingClientRect();if(e.clientX>=E.right-16)return}}w=!0,P=e.clientX-c,_=e.clientY-l,t.style.cursor="grabbing",t.setPointerCapture(e.pointerId)}},G=e=>{w&&(c=e.clientX-P,l=e.clientY-_,g(),h())},U=()=>{w=!1,t.style.cursor=""},j=e=>e.preventDefault();t.addEventListener("wheel",$,{passive:!1}),t.addEventListener("pointerdown",K),t.addEventListener("pointermove",G),t.addEventListener("pointerup",U),t.addEventListener("dragstart",j);let C=0,R=0,k=0,D=!1,J=e=>{if(e.length<2||!e[0]||!e[1])return 0;let s=e[0].clientX-e[1].clientX,a=e[0].clientY-e[1].clientY;return Math.sqrt(s*s+a*a)},Q=e=>{if(e.touches.length===2){let s=e.touches[0],a=e.touches[1];if(!s||!a)return;e.preventDefault(),D=!0,w=!1,C=J(e.touches),R=(s.clientX+a.clientX)/2,k=(s.clientY+a.clientY)/2}},ee=e=>{if(e.touches.length===2&&D){let s=e.touches[0],a=e.touches[1];if(!s||!a)return;e.preventDefault();let E=J(e.touches),M=(s.clientX+a.clientX)/2,p=(s.clientY+a.clientY)/2,ne=t.getBoundingClientRect(),oe=M-ne.left,se=p-ne.top,de=E/C,ae=o;o=Math.max(F,Math.min(X,o*de)),d=o,c=oe-(oe-c)*(o/ae),l=se-(se-l)*(o/ae),c+=M-R,l+=p-k,C=E,R=M,k=p,g(),h()}},te=e=>{e.touches.length<2&&(D=!1)};t.addEventListener("touchstart",Q,{passive:!1}),t.addEventListener("touchmove",ee,{passive:!1}),t.addEventListener("touchend",te),m.push(()=>{t.removeEventListener("wheel",$),t.removeEventListener("pointerdown",K),t.removeEventListener("pointermove",G),t.removeEventListener("pointerup",U),t.removeEventListener("dragstart",j),t.removeEventListener("touchstart",Q),t.removeEventListener("touchmove",ee),t.removeEventListener("touchend",te)})}let B=v?.querySelector(".canvas-sidebar-toggle");if(v&&B){let n=()=>{let r=t.getBoundingClientRect();v.classList.toggle("canvas-sidebar-open"),requestAnimationFrame(()=>{let u=t.getBoundingClientRect().left-r.left;c+=u,Y+=u,g(),h()})};B.addEventListener("click",n),m.push(()=>{B.removeEventListener("click",n)})}let A=t.querySelector(".canvas-zoom-in"),z=t.querySelector(".canvas-zoom-out"),V=n=>{let r=t.getBoundingClientRect();O(n,r.width/2,r.height/2)};if(m.push(()=>{f&&cancelAnimationFrame(f)}),A){let n=()=>{V(1.25)};A.addEventListener("click",n),m.push(()=>A.removeEventListener("click",n))}if(z){let n=()=>{V(.8)};z.addEventListener("click",n),m.push(()=>z.removeEventListener("click",n))}if(y){let n=()=>{W(),Z=o,Y=c,x=l,h()};y.addEventListener("click",n),m.push(()=>y.removeEventListener("click",n))}let H=t.querySelector(".canvas-fullscreen-toggle");if(H){let n=H.querySelector(".canvas-fullscreen-enter"),r=H.querySelector(".canvas-fullscreen-exit"),i=()=>{let S=document.fullscreenElement===t;n&&(n.style.display=S?"none":""),r&&(r.style.display=S?"":"none")},u=()=>{document.fullscreenElement===t?document.exitFullscreen():t.requestFullscreen()},L=()=>{i(),requestAnimationFrame(()=>{W(),Z=o,Y=c,x=l,h()})};H.addEventListener("click",u),document.addEventListener("fullscreenchange",L),m.push(()=>{H.removeEventListener("click",u),document.removeEventListener("fullscreenchange",L)})}let ue=t.querySelectorAll(".canvas-iframe-wrapper iframe");for(let n of Array.from(ue))n.addEventListener("error",()=>{let r=n.parentElement?.querySelector(".canvas-iframe-fallback");r&&(n.style.display="none",r.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let n of m)n();t.dataset.initialized="false"})}}if(typeof document<"u"){let T=()=>{fe()};document.addEventListener("nav",T),document.addEventListener("render",T)}\n';
var l;
