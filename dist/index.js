...
.canvas-node-content.canvas-content-scrollable:not(.canvas-content-at-end) {
...
var canvas_inline_default = 'function ke(){let Y=document.querySelectorAll(".canvas-container");if(Y.length!==0)for(let n of Array.from(Y)){if(n.dataset.initialized==="true")continue;n.dataset.initialized="true";let z=n.querySelector(".canvas-viewport");if(!z)continue;let Oe=n.dataset.enableInteraction!=="false",Ze=n.dataset.defaultFullscreen==="true",p=n.closest(\'.page[data-frame="canvas"]\'),qe=window.matchMedia("(max-width: 800px)").matches;p&&!Ze&&!qe&&(p.classList.add("canvas-init-no-transition","canvas-sidebar-open"),p.offsetWidth,requestAnimationFrame(()=>{p.classList.remove("canvas-init-no-transition")}));let C=parseFloat(n.dataset.minZoom??"")||.1,X=parseFloat(n.dataset.maxZoom??"")||5,xe=parseFloat(n.dataset.initialZoom??"")||1,s=1,f=s,B=0,W=0,u=0,H=0,c=0,i=0,k=!1,se=0,ae=0,g=()=>{z.style.transform=`translate(${c}px, ${i}px) scale(${s})`},re=.9,ce=()=>{let t=n.getBoundingClientRect(),a=parseFloat(z.style.width)||1e3,l=parseFloat(z.style.height)||1e3,v=t.width/a*re,h=t.height/l*re,d=Math.min(v,h,1)*xe;return d=Math.max(C,Math.min(X,d)),{zoom:d,panX:(t.width-a*d)/2,panY:(t.height-l*d)/2}},w=()=>{H&&(cancelAnimationFrame(H),H=0)},G=()=>{let t=ce();s=t.zoom,c=t.panX,i=t.panY,f=s,u&&(cancelAnimationFrame(u),u=0),w(),g()};G();let A=s,R=c,I=i,O=n.querySelector(".canvas-reset-view"),ie=()=>Math.abs(s-A)<=.001&&Math.abs(c-R)<=1&&Math.abs(i-I)<=1,L=()=>{O&&(O.style.display=ie()?"none":"flex")},_=.2,V=()=>{let t=s;s+=(f-s)*_,Math.abs(f-s)<5e-4&&(s=f),c=B-(B-c)*(s/t),i=W-(W-i)*(s/t),g(),L(),u=s===f?0:requestAnimationFrame(V)},$=(t,a,l)=>{w(),f=Math.max(C,Math.min(X,f*t)),B=a,W=l,u||(u=requestAnimationFrame(V))},Z=1,q=0,x=0,le=()=>{s+=(Z-s)*_,c+=(q-c)*_,i+=(x-i)*_,Math.abs(Z-s)<5e-4&&Math.abs(q-c)<.5&&Math.abs(x-i)<.5&&(s=Z,c=q,i=x),f=s,g(),L(),H=s===Z&&c===q&&i===x?0:requestAnimationFrame(le)},U=(t,a,l)=>{Z=Math.max(C,Math.min(X,t)),q=a,x=l,u&&(cancelAnimationFrame(u),u=0),H||(H=requestAnimationFrame(le))},ue=.8,De=2,de=t=>{let a=n.getBoundingClientRect(),l=t.getBoundingClientRect(),v=(l.left-a.left-c)/s,h=(l.top-a.top-i)/s,d=l.width/s,T=l.height/s,E=Math.min(a.width/d*ue,a.height/T*ue,De);U(E,(a.width-d*E)/2-v*E,(a.height-T*E)/2-h*E)},K=t=>{let a=location.pathname+location.search;history.replaceState(null,"",t?`${a}#node=${encodeURIComponent(t)}`:a)},m=[],M=n.getBoundingClientRect(),ze=()=>{let t=n.getBoundingClientRect();if(t.left===M.left&&t.top===M.top&&t.width===M.width&&t.height===M.height)return;let a=ie();c-=t.left-M.left,i-=t.top-M.top,M=t;let l=ce();A=l.zoom,R=l.panX,I=l.panY,a?G():g(),L()},fe=new ResizeObserver(ze);fe.observe(n),m.push(()=>fe.disconnect());let F=4,me=t=>{t.classList.toggle("canvas-content-at-end",t.scrollTop+t.clientHeight>=t.scrollHeight-2)},ve=t=>{t.classList.toggle("canvas-content-scrollable",t.scrollHeight-t.clientHeight>F),me(t)};for(let t of Array.from(n.querySelectorAll(".canvas-node-content")))t instanceof HTMLElement&&ve(t);let he=t=>{t.target instanceof HTMLElement&&t.target.classList.contains("canvas-node-content")&&me(t.target)},Ee=t=>{let a=t.target instanceof HTMLElement?t.target.closest(".canvas-node-content"):null;a instanceof HTMLElement&&ve(a)};if(n.addEventListener("scroll",he,!0),n.addEventListener("load",Ee,!0),m.push(()=>{n.removeEventListener("scroll",he,!0),n.removeEventListener("load",Ee,!0)}),Oe){let l=e=>e.deltaMode!==0?e.deltaY>0?.7692307692307692:1.3:Math.exp(-e.deltaY*.004),v=e=>e.deltaMode!==0?!1:e.deltaX!==0||!Number.isInteger(e.deltaY)?!0:Math.abs(e.deltaY)<40,h=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?e.scrollWidth>e.clientWidth+F:e.scrollHeight>e.clientHeight+F,d=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?!(e.scrollWidth<=e.clientWidth+F||e.scrollLeft<=0&&o.deltaX<0||e.scrollLeft+e.clientWidth>=e.scrollWidth-1&&o.deltaX>0):!(e.scrollHeight<=e.clientHeight+F||e.scrollTop<=0&&o.deltaY<0||e.scrollTop+e.clientHeight>=e.scrollHeight-1&&o.deltaY>0),T=!1,E=e=>{if(T){e.preventDefault();return}let o=n.getBoundingClientRect(),r=e.clientX-o.left,y=e.clientY-o.top;if(e.ctrlKey||e.metaKey){e.preventDefault(),$(l(e),r,y);return}let S=e.target instanceof HTMLElement?e.target.closest(".canvas-node:not(.canvas-node-group)"):null;if(S){let b=S.querySelector(".canvas-node-content");if(b instanceof HTMLElement&&h(b,e)){if(d(b,e))return;e.preventDefault();return}}e.preventDefault(),v(e)?(w(),c-=e.deltaX,i-=e.deltaY,g(),L()):$(l(e),r,y)},ge=e=>{let o=e.button===1;if(!(e.button!==0&&!o)){if(o)e.preventDefault();else if(e.target instanceof HTMLElement){if(e.target.closest("a")||e.target.closest("button"))return;let r=e.target.closest(".canvas-node-content");if(r&&r.scrollHeight>r.clientHeight+F){let y=r.getBoundingClientRect();if(e.clientX>=y.right-16)return}}w(),k=!0,se=e.clientX-c,ae=e.clientY-i,n.style.cursor="grabbing",n.setPointerCapture(e.pointerId)}},Le=e=>{k&&(c=e.clientX-se,i=e.clientY-ae,g(),L())},P=()=>{k=!1,n.style.cursor=""},Me=e=>e.preventDefault();n.addEventListener("wheel",E,{passive:!1}),n.addEventListener("pointerdown",ge),n.addEventListener("pointermove",Le),n.addEventListener("pointerup",P),n.addEventListener("pointercancel",P),n.addEventListener("dragstart",Me);let te=0,ne=0,oe=0,N=!1,Te=e=>{if(e.length<2||!e[0]||!e[1])return 0;let o=e[0].clientX-e[1].clientX,r=e[0].clientY-e[1].clientY;return Math.sqrt(o*o+r*r)},ye=e=>{if(e.touches.length===2){let o=e.touches[0],r=e.touches[1];if(!o||!r)return;e.preventDefault(),w(),N=!0,k=!1,te=Te(e.touches),ne=(o.clientX+r.clientX)/2,oe=(o.clientY+r.clientY)/2}},be=e=>{if(e.touches.length===2&&N){let o=e.touches[0],r=e.touches[1];if(!o||!r)return;e.preventDefault();let y=Te(e.touches),S=(o.clientX+r.clientX)/2,b=(o.clientY+r.clientY)/2,Xe=n.getBoundingClientRect(),Ae=S-Xe.left,Re=b-Xe.top,We=y/te,Ie=s;s=Math.max(C,Math.min(X,s*We)),f=s,c=Ae-(Ae-c)*(s/Ie),i=Re-(Re-i)*(s/Ie),c+=S-ne,i+=b-oe,te=y,ne=S,oe=b,g(),L()}},He=e=>{e.touches.length<2&&(N=!1)};n.addEventListener("touchstart",ye,{passive:!1}),n.addEventListener("touchmove",be,{passive:!1}),n.addEventListener("touchend",He);let we=1,Fe=e=>{e.preventDefault(),!N&&(T=!0,we=f)},Se=e=>{if(e.preventDefault(),!T)return;let o=e,r=n.getBoundingClientRect();f=Math.max(C,Math.min(X,we*o.scale)),B=o.clientX-r.left,W=o.clientY-r.top,u||(u=requestAnimationFrame(V))},Ye=e=>{e.preventDefault(),T=!1};n.addEventListener("gesturestart",Fe),n.addEventListener("gesturechange",Se),n.addEventListener("gestureend",Ye);let Ce=e=>{let o=document.elementFromPoint(e.clientX,e.clientY);if(!(o instanceof HTMLElement)||o.closest("a")||o.closest("button"))return;let r=o.closest(".canvas-node");if(!r){U(A,R,I),K();return}de(r),K(r.dataset.nodeId)};n.addEventListener("dblclick",Ce),m.push(()=>{n.removeEventListener("wheel",E),n.removeEventListener("pointerdown",ge),n.removeEventListener("pointermove",Le),n.removeEventListener("pointerup",P),n.removeEventListener("pointercancel",P),n.removeEventListener("dragstart",Me),n.removeEventListener("touchstart",ye),n.removeEventListener("touchmove",be),n.removeEventListener("touchend",He),n.removeEventListener("gesturestart",Fe),n.removeEventListener("gesturechange",Se),n.removeEventListener("gestureend",Ye),n.removeEventListener("dblclick",Ce)})}let j=p?.querySelector(".canvas-sidebar-toggle");if(p&&j){let t=()=>{p.classList.toggle("canvas-sidebar-open")};j.addEventListener("click",t),m.push(()=>{j.removeEventListener("click",t)})}let J=n.querySelector(".canvas-zoom-in"),Q=n.querySelector(".canvas-zoom-out"),pe=t=>{let a=n.getBoundingClientRect();$(t,a.width/2,a.height/2)};if(m.push(()=>{u&&cancelAnimationFrame(u),w()}),J){let t=()=>{pe(1.25)};J.addEventListener("click",t),m.push(()=>J.removeEventListener("click",t))}if(Q){let t=()=>{pe(.8)};Q.addEventListener("click",t),m.push(()=>Q.removeEventListener("click",t))}if(O){let t=()=>{U(A,R,I),K()};O.addEventListener("click",t),m.push(()=>O.removeEventListener("click",t))}let D=n.querySelector(".canvas-fullscreen-toggle");if(D){let t=D.querySelector(".canvas-fullscreen-enter"),a=D.querySelector(".canvas-fullscreen-exit"),l=()=>{let d=document.fullscreenElement===n;t&&(t.style.display=d?"none":""),a&&(a.style.display=d?"":"none")},v=()=>{document.fullscreenElement===n?document.exitFullscreen():n.requestFullscreen()},h=()=>{l(),requestAnimationFrame(()=>{G(),A=s,R=c,I=i,L()})};D.addEventListener("click",v),document.addEventListener("fullscreenchange",h),m.push(()=>{D.removeEventListener("click",v),document.removeEventListener("fullscreenchange",h)})}let ee=/^#node=([^&]+)/.exec(location.hash);if(ee&&ee[1]){let t=n.querySelector(`.canvas-node[data-node-id="${CSS.escape(decodeURIComponent(ee[1]))}"]`);t instanceof HTMLElement&&de(t)}let Be=n.querySelectorAll(".canvas-iframe-wrapper iframe");for(let t of Array.from(Be))t.addEventListener("error",()=>{let a=t.parentElement?.querySelector(".canvas-iframe-fallback");a&&(t.style.display="none",a.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let t of m)t();n.dataset.initialized="false"})}}if(typeof document<"u"){let Y=()=>{ke()};document.addEventListener("nav",Y),document.addEventListener("render",Y)}\n';
var l;
