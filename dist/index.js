...
var canvas_inline_default = 'function ee(){let p=document.querySelectorAll(".canvas-container");if(p.length!==0)for(let t of Array.from(p)){if(t.dataset.initialized==="true")continue;t.dataset.initialized="true";let M=t.querySelector(".canvas-viewport");if(!M)continue;let J=t.dataset.enableInteraction!=="false",w=parseFloat(t.dataset.minZoom??"")||.1,b=parseFloat(t.dataset.maxZoom??"")||5,s=parseFloat(t.dataset.initialZoom??"")||1,c=0,r=0,y=!1,A=0,P=0,h=()=>{M.style.transform=`translate(${c}px, ${r}px) scale(${s})`},Y=()=>{let n=t.getBoundingClientRect(),l=parseFloat(M.style.width)||1e3,u=parseFloat(M.style.height)||1e3,i=n.width/l,m=n.height/u;s=Math.min(i,m,1)*.9,s=Math.max(w,Math.min(b,s)),c=(n.width-l*s)/2,r=(n.height-u*s)/2,h()};Y();let H=s,T=c,X=r,g=t.querySelector(".canvas-reset-view"),d=()=>{if(!g)return;let n=Math.abs(s-H)>.001||Math.abs(c-T)>1||Math.abs(r-X)>1;g.style.display=n?"flex":"none"},B=(n,l,u)=>{let i=s;s=Math.max(w,Math.min(b,s*n)),c=l-(l-c)*(s/i),r=u-(u-r)*(s/i),h(),d()},f=[];if(J){let n=e=>e.deltaMode!==0?e.deltaY>0?.9:1.1:Math.pow(1.0015,-e.deltaY),l=e=>e.deltaMode!==0?!1:e.deltaX!==0||!Number.isInteger(e.deltaY)?!0:Math.abs(e.deltaY)<40,u=e=>{let o=e.target instanceof HTMLElement?e.target.closest(".canvas-node-content"):null;if(!o||Math.abs(e.deltaX)>Math.abs(e.deltaY)||o.scrollHeight<=o.clientHeight)return!1;let a=o.scrollTop<=0,v=o.scrollTop+o.clientHeight>=o.scrollHeight-1;return!(a&&e.deltaY<0||v&&e.deltaY>0)},i=e=>{let o=t.getBoundingClientRect(),a=e.clientX-o.left,v=e.clientY-o.top;if(e.ctrlKey||e.metaKey){e.preventDefault(),B(n(e),a,v);return}u(e)||(e.preventDefault(),l(e)?(c-=e.deltaX,r-=e.deltaY,h(),d()):B(n(e),a,v))},m=e=>{if(e.button===0&&!(e.target instanceof HTMLElement&&(e.target.closest("a")||e.target.closest("button")))){if(e.target instanceof HTMLElement){let o=e.target.closest(".canvas-node-content");if(o&&o.scrollHeight>o.clientHeight){let a=o.getBoundingClientRect();if(e.clientX>=a.right-16)return}}y=!0,A=e.clientX-c,P=e.clientY-r,t.setPointerCapture(e.pointerId)}},L=e=>{y&&(c=e.clientX-A,r=e.clientY-P,h(),d())},W=()=>{y=!1};t.addEventListener("wheel",i,{passive:!1}),t.addEventListener("pointerdown",m),t.addEventListener("pointermove",L),t.addEventListener("pointerup",W);let x=0,k=0,R=0,z=!1,O=e=>{if(e.length<2||!e[0]||!e[1])return 0;let o=e[0].clientX-e[1].clientX,a=e[0].clientY-e[1].clientY;return Math.sqrt(o*o+a*a)},N=e=>{if(e.touches.length===2){let o=e.touches[0],a=e.touches[1];if(!o||!a)return;e.preventDefault(),z=!0,y=!1,x=O(e.touches),k=(o.clientX+a.clientX)/2,R=(o.clientY+a.clientY)/2}},$=e=>{if(e.touches.length===2&&z){let o=e.touches[0],a=e.touches[1];if(!o||!a)return;e.preventDefault();let v=O(e.touches),I=(o.clientX+a.clientX)/2,Z=(o.clientY+a.clientY)/2,U=t.getBoundingClientRect(),V=I-U.left,j=Z-U.top,_=v/x,G=s;s=Math.max(w,Math.min(b,s*_)),c=V-(V-c)*(s/G),r=j-(j-r)*(s/G),c+=I-k,r+=Z-R,x=v,k=I,R=Z,h(),d()}},K=e=>{e.touches.length<2&&(z=!1)};t.addEventListener("touchstart",N,{passive:!1}),t.addEventListener("touchmove",$,{passive:!1}),t.addEventListener("touchend",K),f.push(()=>{t.removeEventListener("wheel",i),t.removeEventListener("pointerdown",m),t.removeEventListener("pointermove",L),t.removeEventListener("pointerup",W),t.removeEventListener("touchstart",N),t.removeEventListener("touchmove",$),t.removeEventListener("touchend",K)})}let F=t.closest(\'.page[data-frame="canvas"]\'),q=F?.querySelector(".canvas-sidebar-toggle");if(F&&q){let n=()=>{let l=t.getBoundingClientRect();F.classList.toggle("canvas-sidebar-open"),requestAnimationFrame(()=>{let i=t.getBoundingClientRect().left-l.left;c+=i,T+=i,h(),d()})};q.addEventListener("click",n),f.push(()=>{q.removeEventListener("click",n)})}let C=t.querySelector(".canvas-zoom-in"),S=t.querySelector(".canvas-zoom-out"),D=n=>{let l=t.getBoundingClientRect();B(n,l.width/2,l.height/2)};if(C){let n=()=>{D(1.25)};C.addEventListener("click",n),f.push(()=>C.removeEventListener("click",n))}if(S){let n=()=>{D(.8)};S.addEventListener("click",n),f.push(()=>S.removeEventListener("click",n))}if(g){let n=()=>{Y(),H=s,T=c,X=r,d()};g.addEventListener("click",n),f.push(()=>g.removeEventListener("click",n))}let E=t.querySelector(".canvas-fullscreen-toggle");if(E){let n=E.querySelector(".canvas-fullscreen-enter"),l=E.querySelector(".canvas-fullscreen-exit"),u=()=>{let L=document.fullscreenElement===t;n&&(n.style.display=L?"none":""),l&&(l.style.display=L?"":"none")},i=()=>{document.fullscreenElement===t?document.exitFullscreen():t.requestFullscreen()},m=()=>{u(),requestAnimationFrame(()=>{Y(),H=s,T=c,X=r,d()})};E.addEventListener("click",i),document.addEventListener("fullscreenchange",m),f.push(()=>{E.removeEventListener("click",i),document.removeEventListener("fullscreenchange",m)})}let Q=t.querySelectorAll(".canvas-iframe-wrapper iframe");for(let n of Array.from(Q))n.addEventListener("error",()=>{let l=n.parentElement?.querySelector(".canvas-iframe-fallback");l&&(n.style.display="none",l.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let n of f)n();t.dataset.initialized="false"})}}if(typeof document<"u"){let p=()=>{ee()};document.addEventListener("nav",p),document.addEventListener("render",p)}\n';
var l;
