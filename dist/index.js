...
var canvas_inline_default = 'function ke(){let Y=document.querySelectorAll(".canvas-container");if(Y.length!==0)for(let n of Array.from(Y)){if(n.dataset.initialized==="true")continue;n.dataset.initialized="true";let z=n.querySelector(".canvas-viewport");if(!z)continue;let qe=n.dataset.enableInteraction!=="false",se=n.dataset.defaultFullscreen==="true",f=n.closest(\'.page[data-frame="canvas"]\'),xe=window.matchMedia("(max-width: 800px)").matches;f&&!se&&!xe&&(f.classList.add("canvas-no-transition","canvas-sidebar-open"),f.offsetWidth,requestAnimationFrame(()=>{f.classList.remove("canvas-no-transition")}));let C=parseFloat(n.dataset.minZoom??"")||.1,X=parseFloat(n.dataset.maxZoom??"")||5,Ze=parseFloat(n.dataset.initialZoom??"")||1,a=1,m=a,B=0,W=0,u=0,H=0,i=0,l=0,k=!1,ae=0,re=0,p=()=>{z.style.transform=`translate(${i}px, ${l}px) scale(${a})`},ce=.9,ie=()=>{let t=n.getBoundingClientRect(),s=parseFloat(z.style.width)||1e3,c=parseFloat(z.style.height)||1e3,h=t.width/s*ce,E=t.height/c*ce,d=Math.min(h,E,1)*Ze;return d=Math.max(C,Math.min(X,d)),{zoom:d,panX:(t.width-s*d)/2,panY:(t.height-c*d)/2}},w=()=>{H&&(cancelAnimationFrame(H),H=0)},G=()=>{let t=ie();a=t.zoom,i=t.panX,l=t.panY,m=a,u&&(cancelAnimationFrame(u),u=0),w(),p()};G();let A=a,R=i,I=l,O=n.querySelector(".canvas-reset-view"),le=()=>Math.abs(a-A)<=.001&&Math.abs(i-R)<=1&&Math.abs(l-I)<=1,L=()=>{O&&(O.style.display=le()?"none":"flex")},_=.2,V=()=>{let t=a;a+=(m-a)*_,Math.abs(m-a)<5e-4&&(a=m),i=B-(B-i)*(a/t),l=W-(W-l)*(a/t),p(),L(),u=a===m?0:requestAnimationFrame(V)},$=(t,s,c)=>{w(),m=Math.max(C,Math.min(X,m*t)),B=s,W=c,u||(u=requestAnimationFrame(V))},q=1,x=0,Z=0,ue=()=>{a+=(q-a)*_,i+=(x-i)*_,l+=(Z-l)*_,Math.abs(q-a)<5e-4&&Math.abs(x-i)<.5&&Math.abs(Z-l)<.5&&(a=q,i=x,l=Z),m=a,p(),L(),H=a===q&&i===x&&l===Z?0:requestAnimationFrame(ue)},U=(t,s,c)=>{q=Math.max(C,Math.min(X,t)),x=s,Z=c,u&&(cancelAnimationFrame(u),u=0),H||(H=requestAnimationFrame(ue))},de=.8,De=2,fe=t=>{let s=n.getBoundingClientRect(),c=t.getBoundingClientRect(),h=(c.left-s.left-i)/a,E=(c.top-s.top-l)/a,d=c.width/a,T=c.height/a,g=Math.min(s.width/d*de,s.height/T*de,De);U(g,(s.width-d*g)/2-h*g,(s.height-T*g)/2-E*g)},K=t=>{let s=location.pathname+location.search;history.replaceState(null,"",t?`${s}#node=${encodeURIComponent(t)}`:s)},v=[],M=n.getBoundingClientRect(),ze=()=>{let t=n.getBoundingClientRect();if(t.left===M.left&&t.top===M.top&&t.width===M.width&&t.height===M.height)return;let s=le();i-=t.left-M.left,l-=t.top-M.top,M=t;let c=ie();A=c.zoom,R=c.panX,I=c.panY,s?G():p(),L()},me=new ResizeObserver(ze);if(me.observe(n),v.push(()=>me.disconnect()),f&&!se){let t=window.matchMedia("(max-width: 800px)"),s=c=>{f.classList.add("canvas-no-transition"),f.classList.toggle("canvas-sidebar-open",!c.matches),f.offsetWidth,requestAnimationFrame(()=>f.classList.remove("canvas-no-transition"))};t.addEventListener("change",s),v.push(()=>t.removeEventListener("change",s))}let F=4,ve=t=>{t.classList.toggle("canvas-content-at-start",t.scrollTop<=2),t.classList.toggle("canvas-content-at-end",t.scrollTop+t.clientHeight>=t.scrollHeight-2)},he=t=>{t.classList.toggle("canvas-content-scrollable",t.scrollHeight-t.clientHeight>F),ve(t)};for(let t of Array.from(n.querySelectorAll(".canvas-node-content")))t instanceof HTMLElement&&he(t);let Ee=t=>{t.target instanceof HTMLElement&&t.target.classList.contains("canvas-node-content")&&ve(t.target)},ge=t=>{let s=t.target instanceof HTMLElement?t.target.closest(".canvas-node-content"):null;s instanceof HTMLElement&&he(s)};if(n.addEventListener("scroll",Ee,!0),n.addEventListener("load",ge,!0),v.push(()=>{n.removeEventListener("scroll",Ee,!0),n.removeEventListener("load",ge,!0)}),qe){let c=e=>e.deltaMode!==0?e.deltaY>0?.7692307692307692:1.3:Math.exp(-e.deltaY*.004),h=e=>e.deltaMode!==0?!1:e.deltaX!==0||!Number.isInteger(e.deltaY)?!0:Math.abs(e.deltaY)<40,E=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?e.scrollWidth>e.clientWidth+F:e.scrollHeight>e.clientHeight+F,d=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?!(e.scrollWidth<=e.clientWidth+F||e.scrollLeft<=0&&o.deltaX<0||e.scrollLeft+e.clientWidth>=e.scrollWidth-1&&o.deltaX>0):!(e.scrollHeight<=e.clientHeight+F||e.scrollTop<=0&&o.deltaY<0||e.scrollTop+e.clientHeight>=e.scrollHeight-1&&o.deltaY>0),T=!1,g=e=>{if(T){e.preventDefault();return}let o=n.getBoundingClientRect(),r=e.clientX-o.left,y=e.clientY-o.top;if(e.ctrlKey||e.metaKey){e.preventDefault(),$(c(e),r,y);return}let S=e.target instanceof HTMLElement?e.target.closest(".canvas-node:not(.canvas-node-group)"):null;if(S){let b=S.querySelector(".canvas-node-content");if(b instanceof HTMLElement&&E(b,e)){if(d(b,e))return;e.preventDefault();return}}e.preventDefault(),h(e)?(w(),i-=e.deltaX,l-=e.deltaY,p(),L()):$(c(e),r,y)},Le=e=>{let o=e.button===1;if(!(e.button!==0&&!o)){if(o)e.preventDefault();else if(e.target instanceof HTMLElement){if(e.target.closest("a")||e.target.closest("button"))return;let r=e.target.closest(".canvas-node-content");if(r&&r.scrollHeight>r.clientHeight+F){let y=r.getBoundingClientRect();if(e.clientX>=y.right-16)return}}w(),k=!0,ae=e.clientX-i,re=e.clientY-l,n.style.cursor="grabbing",n.setPointerCapture(e.pointerId)}},Me=e=>{k&&(i=e.clientX-ae,l=e.clientY-re,p(),L())},P=()=>{k=!1,n.style.cursor=""},Te=e=>e.preventDefault();n.addEventListener("wheel",g,{passive:!1}),n.addEventListener("pointerdown",Le),n.addEventListener("pointermove",Me),n.addEventListener("pointerup",P),n.addEventListener("pointercancel",P),n.addEventListener("dragstart",Te);let te=0,ne=0,oe=0,N=!1,ye=e=>{if(e.length<2||!e[0]||!e[1])return 0;let o=e[0].clientX-e[1].clientX,r=e[0].clientY-e[1].clientY;return Math.sqrt(o*o+r*r)},be=e=>{if(e.touches.length===2){let o=e.touches[0],r=e.touches[1];if(!o||!r)return;e.preventDefault(),w(),N=!0,k=!1,te=ye(e.touches),ne=(o.clientX+r.clientX)/2,oe=(o.clientY+r.clientY)/2}},He=e=>{if(e.touches.length===2&&N){let o=e.touches[0],r=e.touches[1];if(!o||!r)return;e.preventDefault();let y=ye(e.touches),S=(o.clientX+r.clientX)/2,b=(o.clientY+r.clientY)/2,Ae=n.getBoundingClientRect(),Re=S-Ae.left,Ie=b-Ae.top,We=y/te,Oe=a;a=Math.max(C,Math.min(X,a*We)),m=a,i=Re-(Re-i)*(a/Oe),l=Ie-(Ie-l)*(a/Oe),i+=S-ne,l+=b-oe,te=y,ne=S,oe=b,p(),L()}},we=e=>{e.touches.length<2&&(N=!1)};n.addEventListener("touchstart",be,{passive:!1}),n.addEventListener("touchmove",He,{passive:!1}),n.addEventListener("touchend",we);let Fe=1,Se=e=>{e.preventDefault(),!N&&(T=!0,Fe=m)},Ye=e=>{if(e.preventDefault(),!T)return;let o=e,r=n.getBoundingClientRect();m=Math.max(C,Math.min(X,Fe*o.scale)),B=o.clientX-r.left,W=o.clientY-r.top,u||(u=requestAnimationFrame(V))},Ce=e=>{e.preventDefault(),T=!1};n.addEventListener("gesturestart",Se),n.addEventListener("gesturechange",Ye),n.addEventListener("gestureend",Ce);let Xe=e=>{let o=document.elementFromPoint(e.clientX,e.clientY);if(!(o instanceof HTMLElement)||o.closest("a")||o.closest("button"))return;let r=o.closest(".canvas-node");if(!r){U(A,R,I),K();return}fe(r),K(r.dataset.nodeId)};n.addEventListener("dblclick",Xe),v.push(()=>{n.removeEventListener("wheel",g),n.removeEventListener("pointerdown",Le),n.removeEventListener("pointermove",Me),n.removeEventListener("pointerup",P),n.removeEventListener("pointercancel",P),n.removeEventListener("dragstart",Te),n.removeEventListener("touchstart",be),n.removeEventListener("touchmove",He),n.removeEventListener("touchend",we),n.removeEventListener("gesturestart",Se),n.removeEventListener("gesturechange",Ye),n.removeEventListener("gestureend",Ce),n.removeEventListener("dblclick",Xe)})}let Q=f?.querySelector(".canvas-sidebar-toggle");if(f&&Q){let t=()=>{f.classList.toggle("canvas-sidebar-open")};Q.addEventListener("click",t),v.push(()=>{Q.removeEventListener("click",t)})}let j=n.querySelector(".canvas-zoom-in"),J=n.querySelector(".canvas-zoom-out"),pe=t=>{let s=n.getBoundingClientRect();$(t,s.width/2,s.height/2)};if(v.push(()=>{u&&cancelAnimationFrame(u),w()}),j){let t=()=>{pe(1.25)};j.addEventListener("click",t),v.push(()=>j.removeEventListener("click",t))}if(J){let t=()=>{pe(.8)};J.addEventListener("click",t),v.push(()=>J.removeEventListener("click",t))}if(O){let t=()=>{U(A,R,I),K()};O.addEventListener("click",t),v.push(()=>O.removeEventListener("click",t))}let D=n.querySelector(".canvas-fullscreen-toggle");if(D){let t=D.querySelector(".canvas-fullscreen-enter"),s=D.querySelector(".canvas-fullscreen-exit"),c=()=>{let d=document.fullscreenElement===n;t&&(t.style.display=d?"none":""),s&&(s.style.display=d?"":"none")},h=()=>{document.fullscreenElement===n?document.exitFullscreen():n.requestFullscreen()},E=()=>{c(),requestAnimationFrame(()=>{G(),A=a,R=i,I=l,L()})};D.addEventListener("click",h),document.addEventListener("fullscreenchange",E),v.push(()=>{D.removeEventListener("click",h),document.removeEventListener("fullscreenchange",E)})}let ee=/^#node=([^&]+)/.exec(location.hash);if(ee&&ee[1]){let t=n.querySelector(`.canvas-node[data-node-id="${CSS.escape(decodeURIComponent(ee[1]))}"]`);t instanceof HTMLElement&&fe(t)}let Be=n.querySelectorAll(".canvas-iframe-wrapper iframe");for(let t of Array.from(Be))t.addEventListener("error",()=>{let s=t.parentElement?.querySelector(".canvas-iframe-fallback");s&&(t.style.display="none",s.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let t of v)t();n.dataset.initialized="false"})}}if(typeof document<"u"){let Y=()=>{ke()};document.addEventListener("nav",Y),document.addEventListener("render",Y)}\n';
var l;
