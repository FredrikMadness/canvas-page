...
var canvas_inline_default = 'function we(){let b=document.querySelectorAll(".canvas-container");if(b.length!==0)for(let t of Array.from(b)){if(t.dataset.initialized==="true")continue;t.dataset.initialized="true";let H=t.querySelector(".canvas-viewport");if(!H)continue;let pe=t.dataset.enableInteraction!=="false",Ee=t.dataset.defaultFullscreen==="true",v=t.closest(\'.page[data-frame="canvas"]\'),ge=window.matchMedia("(max-width: 800px)").matches;v&&!Ee&&!ge&&(v.classList.add("canvas-init-no-transition","canvas-sidebar-open"),v.offsetWidth,requestAnimationFrame(()=>{v.classList.remove("canvas-init-no-transition")}));let S=parseFloat(t.dataset.minZoom??"")||.1,X=parseFloat(t.dataset.maxZoom??"")||5,Le=parseFloat(t.dataset.initialZoom??"")||1,s=1,u=s,F=0,Z=0,d=0,i=0,c=0,I=!1,V=0,$=0,L=()=>{H.style.transform=`translate(${i}px, ${c}px) scale(${s})`},K=.9,U=()=>{let n=t.getBoundingClientRect(),a=parseFloat(H.style.width)||1e3,l=parseFloat(H.style.height)||1e3,M=n.width/a*K,T=n.height/l*K,f=Math.min(M,T,1)*Le;return f=Math.max(S,Math.min(X,f)),{zoom:f,panX:(n.width-a*f)/2,panY:(n.height-l*f)/2}},z=()=>{let n=U();s=n.zoom,i=n.panX,c=n.panY,u=s,d&&(cancelAnimationFrame(d),d=0),L()};z();let O=s,q=i,x=c,w=t.querySelector(".canvas-reset-view"),j=()=>Math.abs(s-O)<=.001&&Math.abs(i-q)<=1&&Math.abs(c-x)<=1,h=()=>{w&&(w.style.display=j()?"none":"flex")},Me=.2,B=()=>{let n=s;s+=(u-s)*Me,Math.abs(u-s)<5e-4&&(s=u),i=F-(F-i)*(s/n),c=Z-(Z-c)*(s/n),L(),h(),d=s===u?0:requestAnimationFrame(B)},C=(n,a,l)=>{u=Math.max(S,Math.min(X,u*n)),F=a,Z=l,d||(d=requestAnimationFrame(B))},m=[],p=t.getBoundingClientRect(),Te=()=>{let n=t.getBoundingClientRect();if(n.left===p.left&&n.top===p.top&&n.width===p.width&&n.height===p.height)return;let a=j();i-=n.left-p.left,c-=n.top-p.top,p=n;let l=U();O=l.zoom,q=l.panX,x=l.panY,a?z():L(),h()},J=new ResizeObserver(Te);if(J.observe(t),m.push(()=>J.disconnect()),pe){let l=e=>e.deltaMode!==0?e.deltaY>0?.7692307692307692:1.3:Math.exp(-e.deltaY*.004),M=e=>e.deltaMode!==0?!1:e.deltaX!==0||!Number.isInteger(e.deltaY)?!0:Math.abs(e.deltaY)<40,T=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?e.scrollWidth>e.clientWidth:e.scrollHeight>e.clientHeight,f=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?!(e.scrollWidth<=e.clientWidth||e.scrollLeft<=0&&o.deltaX<0||e.scrollLeft+e.clientWidth>=e.scrollWidth-1&&o.deltaX>0):!(e.scrollHeight<=e.clientHeight||e.scrollTop<=0&&o.deltaY<0||e.scrollTop+e.clientHeight>=e.scrollHeight-1&&o.deltaY>0),D=!1,ee=e=>{if(D){e.preventDefault();return}let o=t.getBoundingClientRect(),r=e.clientX-o.left,E=e.clientY-o.top;if(e.ctrlKey||e.metaKey){e.preventDefault(),C(l(e),r,E);return}let y=e.target instanceof HTMLElement?e.target.closest(".canvas-node:not(.canvas-node-group)"):null;if(y){let g=y.querySelector(".canvas-node-content");if(g instanceof HTMLElement&&T(g,e)){if(f(g,e))return;e.preventDefault();return}}e.preventDefault(),M(e)?(i-=e.deltaX,c-=e.deltaY,L(),h()):C(l(e),r,E)},te=e=>{let o=e.button===1;if(!(e.button!==0&&!o)){if(o)e.preventDefault();else if(e.target instanceof HTMLElement){if(e.target.closest("a")||e.target.closest("button"))return;let r=e.target.closest(".canvas-node-content");if(r&&r.scrollHeight>r.clientHeight){let E=r.getBoundingClientRect();if(e.clientX>=E.right-16)return}}I=!0,V=e.clientX-i,$=e.clientY-c,t.style.cursor="grabbing",t.setPointerCapture(e.pointerId)}},ne=e=>{I&&(i=e.clientX-V,c=e.clientY-$,L(),h())},W=()=>{I=!1,t.style.cursor=""},oe=e=>e.preventDefault();t.addEventListener("wheel",ee,{passive:!1}),t.addEventListener("pointerdown",te),t.addEventListener("pointermove",ne),t.addEventListener("pointerup",W),t.addEventListener("pointercancel",W),t.addEventListener("dragstart",oe);let _=0,G=0,N=0,A=!1,se=e=>{if(e.length<2||!e[0]||!e[1])return 0;let o=e[0].clientX-e[1].clientX,r=e[0].clientY-e[1].clientY;return Math.sqrt(o*o+r*r)},re=e=>{if(e.touches.length===2){let o=e.touches[0],r=e.touches[1];if(!o||!r)return;e.preventDefault(),A=!0,I=!1,_=se(e.touches),G=(o.clientX+r.clientX)/2,N=(o.clientY+r.clientY)/2}},ae=e=>{if(e.touches.length===2&&A){let o=e.touches[0],r=e.touches[1];if(!o||!r)return;e.preventDefault();let E=se(e.touches),y=(o.clientX+r.clientX)/2,g=(o.clientY+r.clientY)/2,fe=t.getBoundingClientRect(),me=y-fe.left,ve=g-fe.top,be=E/_,he=s;s=Math.max(S,Math.min(X,s*be)),u=s,i=me-(me-i)*(s/he),c=ve-(ve-c)*(s/he),i+=y-G,c+=g-N,_=E,G=y,N=g,L(),h()}},ie=e=>{e.touches.length<2&&(A=!1)};t.addEventListener("touchstart",re,{passive:!1}),t.addEventListener("touchmove",ae,{passive:!1}),t.addEventListener("touchend",ie);let ce=1,le=e=>{e.preventDefault(),!A&&(D=!0,ce=u)},ue=e=>{if(e.preventDefault(),!D)return;let o=e,r=t.getBoundingClientRect();u=Math.max(S,Math.min(X,ce*o.scale)),F=o.clientX-r.left,Z=o.clientY-r.top,d||(d=requestAnimationFrame(B))},de=e=>{e.preventDefault(),D=!1};t.addEventListener("gesturestart",le),t.addEventListener("gesturechange",ue),t.addEventListener("gestureend",de),m.push(()=>{t.removeEventListener("wheel",ee),t.removeEventListener("pointerdown",te),t.removeEventListener("pointermove",ne),t.removeEventListener("pointerup",W),t.removeEventListener("pointercancel",W),t.removeEventListener("dragstart",oe),t.removeEventListener("touchstart",re),t.removeEventListener("touchmove",ae),t.removeEventListener("touchend",ie),t.removeEventListener("gesturestart",le),t.removeEventListener("gesturechange",ue),t.removeEventListener("gestureend",de)})}let R=v?.querySelector(".canvas-sidebar-toggle");if(v&&R){let n=()=>{v.classList.toggle("canvas-sidebar-open")};R.addEventListener("click",n),m.push(()=>{R.removeEventListener("click",n)})}let k=t.querySelector(".canvas-zoom-in"),P=t.querySelector(".canvas-zoom-out"),Q=n=>{let a=t.getBoundingClientRect();C(n,a.width/2,a.height/2)};if(m.push(()=>{d&&cancelAnimationFrame(d)}),k){let n=()=>{Q(1.25)};k.addEventListener("click",n),m.push(()=>k.removeEventListener("click",n))}if(P){let n=()=>{Q(.8)};P.addEventListener("click",n),m.push(()=>P.removeEventListener("click",n))}if(w){let n=()=>{z(),O=s,q=i,x=c,h()};w.addEventListener("click",n),m.push(()=>w.removeEventListener("click",n))}let Y=t.querySelector(".canvas-fullscreen-toggle");if(Y){let n=Y.querySelector(".canvas-fullscreen-enter"),a=Y.querySelector(".canvas-fullscreen-exit"),l=()=>{let f=document.fullscreenElement===t;n&&(n.style.display=f?"none":""),a&&(a.style.display=f?"":"none")},M=()=>{document.fullscreenElement===t?document.exitFullscreen():t.requestFullscreen()},T=()=>{l(),requestAnimationFrame(()=>{z(),O=s,q=i,x=c,h()})};Y.addEventListener("click",M),document.addEventListener("fullscreenchange",T),m.push(()=>{Y.removeEventListener("click",M),document.removeEventListener("fullscreenchange",T)})}let ye=t.querySelectorAll(".canvas-iframe-wrapper iframe");for(let n of Array.from(ye))n.addEventListener("error",()=>{let a=n.parentElement?.querySelector(".canvas-iframe-fallback");a&&(n.style.display="none",a.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let n of m)n();t.dataset.initialized="false"})}}if(typeof document<"u"){let b=()=>{we()};document.addEventListener("nav",b),document.addEventListener("render",b)}\n';
var l;
