...
var canvas_inline_default = 'function se(){let g=document.querySelectorAll(".canvas-container");if(g.length!==0)for(let t of Array.from(g)){if(t.dataset.initialized==="true")continue;t.dataset.initialized="true";let w=t.querySelector(".canvas-viewport");if(!w)continue;let Q=t.dataset.enableInteraction!=="false",ee=t.dataset.defaultFullscreen==="true",d=t.closest(\'.page[data-frame="canvas"]\'),te=window.matchMedia("(max-width: 800px)").matches;d&&!ee&&!te&&(d.classList.add("canvas-init-no-transition","canvas-sidebar-open"),d.offsetWidth,requestAnimationFrame(()=>{d.classList.remove("canvas-init-no-transition")}));let b=parseFloat(t.dataset.minZoom??"")||.1,S=parseFloat(t.dataset.maxZoom??"")||5,s=parseFloat(t.dataset.initialZoom??"")||1,c=0,l=0,H=!1,R=0,P=0,v=()=>{w.style.transform=`translate(${c}px, ${l}px) scale(${s})`},X=()=>{let n=t.getBoundingClientRect(),a=parseFloat(w.style.width)||1e3,u=parseFloat(w.style.height)||1e3,i=n.width/a,h=n.height/u;s=Math.min(i,h,1)*.9,s=Math.max(b,Math.min(S,s)),c=(n.width-a*s)/2,l=(n.height-u*s)/2,v()};X();let F=s,Y=c,I=l,L=t.querySelector(".canvas-reset-view"),f=()=>{if(!L)return;let n=Math.abs(s-F)>.001||Math.abs(c-Y)>1||Math.abs(l-I)>1;L.style.display=n?"flex":"none"},q=(n,a,u)=>{let i=s;s=Math.max(b,Math.min(S,s*n)),c=a-(a-c)*(s/i),l=u-(u-l)*(s/i),v(),f()},m=[];if(Q){let u=e=>e.deltaMode!==0?e.deltaY>0?.7692307692307692:1.3:Math.exp(-e.deltaY*.004),i=e=>e.deltaMode!==0?!1:e.deltaX!==0||!Number.isInteger(e.deltaY)?!0:Math.abs(e.deltaY)<40,h=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?!(e.scrollWidth<=e.clientWidth||e.scrollLeft<=0&&o.deltaX<0||e.scrollLeft+e.clientWidth>=e.scrollWidth-1&&o.deltaX>0):!(e.scrollHeight<=e.clientHeight||e.scrollTop<=0&&o.deltaY<0||e.scrollTop+e.clientHeight>=e.scrollHeight-1&&o.deltaY>0),T=e=>{let o=t.getBoundingClientRect(),r=e.clientX-o.left,y=e.clientY-o.top;if(e.ctrlKey||e.metaKey){e.preventDefault(),q(u(e),r,y);return}let E=e.target instanceof HTMLElement?e.target.closest(".canvas-node:not(.canvas-node-group)"):null;if(E){let p=E.querySelector(".canvas-node-content");if(p instanceof HTMLElement&&h(p,e))return;e.preventDefault();return}e.preventDefault(),i(e)?(c-=e.deltaX,l-=e.deltaY,v(),f()):q(u(e),r,y)},A=e=>{if(e.button===0&&!(e.target instanceof HTMLElement&&(e.target.closest("a")||e.target.closest("button")))){if(e.target instanceof HTMLElement){let o=e.target.closest(".canvas-node-content");if(o&&o.scrollHeight>o.clientHeight){let r=o.getBoundingClientRect();if(e.clientX>=r.right-16)return}}H=!0,R=e.clientX-c,P=e.clientY-l,t.setPointerCapture(e.pointerId)}},_=e=>{H&&(c=e.clientX-R,l=e.clientY-P,v(),f())},D=()=>{H=!1};t.addEventListener("wheel",T,{passive:!1}),t.addEventListener("pointerdown",A),t.addEventListener("pointermove",_),t.addEventListener("pointerup",D);let Z=0,C=0,O=0,k=!1,N=e=>{if(e.length<2||!e[0]||!e[1])return 0;let o=e[0].clientX-e[1].clientX,r=e[0].clientY-e[1].clientY;return Math.sqrt(o*o+r*r)},V=e=>{if(e.touches.length===2){let o=e.touches[0],r=e.touches[1];if(!o||!r)return;e.preventDefault(),k=!0,H=!1,Z=N(e.touches),C=(o.clientX+r.clientX)/2,O=(o.clientY+r.clientY)/2}},$=e=>{if(e.touches.length===2&&k){let o=e.touches[0],r=e.touches[1];if(!o||!r)return;e.preventDefault();let y=N(e.touches),E=(o.clientX+r.clientX)/2,p=(o.clientY+r.clientY)/2,U=t.getBoundingClientRect(),j=E-U.left,G=p-U.top,oe=y/Z,J=s;s=Math.max(b,Math.min(S,s*oe)),c=j-(j-c)*(s/J),l=G-(G-l)*(s/J),c+=E-C,l+=p-O,Z=y,C=E,O=p,v(),f()}},K=e=>{e.touches.length<2&&(k=!1)};t.addEventListener("touchstart",V,{passive:!1}),t.addEventListener("touchmove",$,{passive:!1}),t.addEventListener("touchend",K),m.push(()=>{t.removeEventListener("wheel",T),t.removeEventListener("pointerdown",A),t.removeEventListener("pointermove",_),t.removeEventListener("pointerup",D),t.removeEventListener("touchstart",V),t.removeEventListener("touchmove",$),t.removeEventListener("touchend",K)})}let x=d?.querySelector(".canvas-sidebar-toggle");if(d&&x){let n=()=>{let a=t.getBoundingClientRect();d.classList.toggle("canvas-sidebar-open"),requestAnimationFrame(()=>{let i=t.getBoundingClientRect().left-a.left;c+=i,Y+=i,v(),f()})};x.addEventListener("click",n),m.push(()=>{x.removeEventListener("click",n)})}let B=t.querySelector(".canvas-zoom-in"),W=t.querySelector(".canvas-zoom-out"),z=n=>{let a=t.getBoundingClientRect();q(n,a.width/2,a.height/2)};if(B){let n=()=>{z(1.25)};B.addEventListener("click",n),m.push(()=>B.removeEventListener("click",n))}if(W){let n=()=>{z(.8)};W.addEventListener("click",n),m.push(()=>W.removeEventListener("click",n))}if(L){let n=()=>{X(),F=s,Y=c,I=l,f()};L.addEventListener("click",n),m.push(()=>L.removeEventListener("click",n))}let M=t.querySelector(".canvas-fullscreen-toggle");if(M){let n=M.querySelector(".canvas-fullscreen-enter"),a=M.querySelector(".canvas-fullscreen-exit"),u=()=>{let T=document.fullscreenElement===t;n&&(n.style.display=T?"none":""),a&&(a.style.display=T?"":"none")},i=()=>{document.fullscreenElement===t?document.exitFullscreen():t.requestFullscreen()},h=()=>{u(),requestAnimationFrame(()=>{X(),F=s,Y=c,I=l,f()})};M.addEventListener("click",i),document.addEventListener("fullscreenchange",h),m.push(()=>{M.removeEventListener("click",i),document.removeEventListener("fullscreenchange",h)})}let ne=t.querySelectorAll(".canvas-iframe-wrapper iframe");for(let n of Array.from(ne))n.addEventListener("error",()=>{let a=n.parentElement?.querySelector(".canvas-iframe-fallback");a&&(n.style.display="none",a.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let n of m)n();t.dataset.initialized="false"})}}if(typeof document<"u"){let g=()=>{se()};document.addEventListener("nav",g),document.addEventListener("render",g)}\n';
var l;
