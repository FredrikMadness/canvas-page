...
var canvas_inline_default = 'function xe(){let Y=document.querySelectorAll(".canvas-container");if(Y.length!==0)for(let n of Array.from(Y)){if(n.dataset.initialized==="true")continue;n.dataset.initialized="true";let z=n.querySelector(".canvas-viewport");if(!z)continue;let Oe=n.dataset.enableInteraction!=="false",Ie=n.dataset.defaultFullscreen==="true",g=n.closest(\'.page[data-frame="canvas"]\'),Ze=window.matchMedia("(max-width: 800px)").matches;g&&!Ie&&!Ze&&(g.classList.add("canvas-init-no-transition","canvas-sidebar-open"),g.offsetWidth,requestAnimationFrame(()=>{g.classList.remove("canvas-init-no-transition")}));let X=parseFloat(n.dataset.minZoom??"")||.1,S=parseFloat(n.dataset.maxZoom??"")||5,Re=parseFloat(n.dataset.initialZoom??"")||1,s=1,f=s,W=0,k=0,d=0,y=0,c=0,i=0,_=!1,ae=0,re=0,p=()=>{z.style.transform=`translate(${c}px, ${i}px) scale(${s})`},ce=.9,ie=()=>{let t=n.getBoundingClientRect(),r=parseFloat(z.style.width)||1e3,l=parseFloat(z.style.height)||1e3,w=t.width/r*ce,F=t.height/l*ce,h=Math.min(w,F,1)*Re;return h=Math.max(X,Math.min(S,h)),{zoom:h,panX:(t.width-r*h)/2,panY:(t.height-l*h)/2}},b=()=>{y&&(cancelAnimationFrame(y),y=0)},$=()=>{let t=ie();s=t.zoom,c=t.panX,i=t.panY,f=s,d&&(cancelAnimationFrame(d),d=0),b(),p()};$();let C=s,A=c,O=i,I=n.querySelector(".canvas-reset-view"),le=()=>Math.abs(s-C)<=.001&&Math.abs(c-A)<=1&&Math.abs(i-O)<=1,L=()=>{I&&(I.style.display=le()?"none":"flex")},P=.2,U=()=>{let t=s;s+=(f-s)*P,Math.abs(f-s)<5e-4&&(s=f),c=W-(W-c)*(s/t),i=k-(k-i)*(s/t),p(),L(),d=s===f?0:requestAnimationFrame(U)},j=(t,r,l)=>{b(),f=Math.max(X,Math.min(S,f*t)),W=r,k=l,d||(d=requestAnimationFrame(U))},Z=1,R=0,q=0,ue=()=>{s+=(Z-s)*P,c+=(R-c)*P,i+=(q-i)*P,Math.abs(Z-s)<5e-4&&Math.abs(R-c)<.5&&Math.abs(q-i)<.5&&(s=Z,c=R,i=q),f=s,p(),L(),y=s===Z&&c===R&&i===q?0:requestAnimationFrame(ue)},J=(t,r,l)=>{Z=Math.max(X,Math.min(S,t)),R=r,q=l,d&&(cancelAnimationFrame(d),d=0),y||(y=requestAnimationFrame(ue))},v=[],M=n.getBoundingClientRect(),qe=()=>{let t=n.getBoundingClientRect();if(t.left===M.left&&t.top===M.top&&t.width===M.width&&t.height===M.height)return;let r=le();c-=t.left-M.left,i-=t.top-M.top,M=t;let l=ie();C=l.zoom,A=l.panX,O=l.panY,r?$():p(),L()},de=new ResizeObserver(qe);de.observe(n),v.push(()=>de.disconnect());let H=4,fe=t=>{t.classList.toggle("canvas-content-at-end",t.scrollTop+t.clientHeight>=t.scrollHeight-2)},me=t=>{t.classList.toggle("canvas-content-scrollable",t.scrollHeight-t.clientHeight>H),fe(t)};for(let t of Array.from(n.querySelectorAll(".canvas-node-content")))t instanceof HTMLElement&&me(t);let ve=t=>{t.target instanceof HTMLElement&&t.target.classList.contains("canvas-node-content")&&fe(t.target)},he=t=>{let r=t.target instanceof HTMLElement?t.target.closest(".canvas-node-content"):null;r instanceof HTMLElement&&me(r)};if(n.addEventListener("scroll",ve,!0),n.addEventListener("load",he,!0),v.push(()=>{n.removeEventListener("scroll",ve,!0),n.removeEventListener("load",he,!0)}),Oe){let l=e=>e.deltaMode!==0?e.deltaY>0?.7692307692307692:1.3:Math.exp(-e.deltaY*.004),w=e=>e.deltaMode!==0?!1:e.deltaX!==0||!Number.isInteger(e.deltaY)?!0:Math.abs(e.deltaY)<40,F=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?e.scrollWidth>e.clientWidth+H:e.scrollHeight>e.clientHeight+H,h=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?!(e.scrollWidth<=e.clientWidth+H||e.scrollLeft<=0&&o.deltaX<0||e.scrollLeft+e.clientWidth>=e.scrollWidth-1&&o.deltaX>0):!(e.scrollHeight<=e.clientHeight+H||e.scrollTop<=0&&o.deltaY<0||e.scrollTop+e.clientHeight>=e.scrollHeight-1&&o.deltaY>0),N=!1,ge=e=>{if(N){e.preventDefault();return}let o=n.getBoundingClientRect(),a=e.clientX-o.left,u=e.clientY-o.top;if(e.ctrlKey||e.metaKey){e.preventDefault(),j(l(e),a,u);return}let m=e.target instanceof HTMLElement?e.target.closest(".canvas-node:not(.canvas-node-group)"):null;if(m){let E=m.querySelector(".canvas-node-content");if(E instanceof HTMLElement&&F(E,e)){if(h(E,e))return;e.preventDefault();return}}e.preventDefault(),w(e)?(b(),c-=e.deltaX,i-=e.deltaY,p(),L()):j(l(e),a,u)},pe=e=>{let o=e.button===1;if(!(e.button!==0&&!o)){if(o)e.preventDefault();else if(e.target instanceof HTMLElement){if(e.target.closest("a")||e.target.closest("button"))return;let a=e.target.closest(".canvas-node-content");if(a&&a.scrollHeight>a.clientHeight+H){let u=a.getBoundingClientRect();if(e.clientX>=u.right-16)return}}b(),_=!0,ae=e.clientX-c,re=e.clientY-i,n.style.cursor="grabbing",n.setPointerCapture(e.pointerId)}},Le=e=>{_&&(c=e.clientX-ae,i=e.clientY-re,p(),L())},G=()=>{_=!1,n.style.cursor=""},Me=e=>e.preventDefault();n.addEventListener("wheel",ge,{passive:!1}),n.addEventListener("pointerdown",pe),n.addEventListener("pointermove",Le),n.addEventListener("pointerup",G),n.addEventListener("pointercancel",G),n.addEventListener("dragstart",Me);let ne=0,oe=0,se=0,V=!1,Te=e=>{if(e.length<2||!e[0]||!e[1])return 0;let o=e[0].clientX-e[1].clientX,a=e[0].clientY-e[1].clientY;return Math.sqrt(o*o+a*a)},ye=e=>{if(e.touches.length===2){let o=e.touches[0],a=e.touches[1];if(!o||!a)return;e.preventDefault(),b(),V=!0,_=!1,ne=Te(e.touches),oe=(o.clientX+a.clientX)/2,se=(o.clientY+a.clientY)/2}},be=e=>{if(e.touches.length===2&&V){let o=e.touches[0],a=e.touches[1];if(!o||!a)return;e.preventDefault();let u=Te(e.touches),m=(o.clientX+a.clientX)/2,E=(o.clientY+a.clientY)/2,K=n.getBoundingClientRect(),D=m-K.left,x=E-K.top,T=u/ne,Ae=s;s=Math.max(X,Math.min(S,s*T)),f=s,c=D-(D-c)*(s/Ae),i=x-(x-i)*(s/Ae),c+=m-oe,i+=E-se,ne=u,oe=m,se=E,p(),L()}},He=e=>{e.touches.length<2&&(V=!1)};n.addEventListener("touchstart",ye,{passive:!1}),n.addEventListener("touchmove",be,{passive:!1}),n.addEventListener("touchend",He);let we=1,Fe=e=>{e.preventDefault(),!V&&(N=!0,we=f)},Ye=e=>{if(e.preventDefault(),!N)return;let o=e,a=n.getBoundingClientRect();f=Math.max(X,Math.min(S,we*o.scale)),W=o.clientX-a.left,k=o.clientY-a.top,d||(d=requestAnimationFrame(U))},Xe=e=>{e.preventDefault(),N=!1};n.addEventListener("gesturestart",Fe),n.addEventListener("gesturechange",Ye),n.addEventListener("gestureend",Xe);let Se=.8,De=2,Ce=e=>{let o=document.elementFromPoint(e.clientX,e.clientY);if(!(o instanceof HTMLElement)||o.closest("a")||o.closest("button"))return;let a=o.closest(".canvas-node");if(!a){J(C,A,O);return}let u=n.getBoundingClientRect(),m=a.getBoundingClientRect(),E=(m.left-u.left-c)/s,K=(m.top-u.top-i)/s,D=m.width/s,x=m.height/s,T=Math.min(u.width/D*Se,u.height/x*Se,De);J(T,(u.width-D*T)/2-E*T,(u.height-x*T)/2-K*T)};n.addEventListener("dblclick",Ce),v.push(()=>{n.removeEventListener("wheel",ge),n.removeEventListener("pointerdown",pe),n.removeEventListener("pointermove",Le),n.removeEventListener("pointerup",G),n.removeEventListener("pointercancel",G),n.removeEventListener("dragstart",Me),n.removeEventListener("touchstart",ye),n.removeEventListener("touchmove",be),n.removeEventListener("touchend",He),n.removeEventListener("gesturestart",Fe),n.removeEventListener("gesturechange",Ye),n.removeEventListener("gestureend",Xe),n.removeEventListener("dblclick",Ce)})}let Q=g?.querySelector(".canvas-sidebar-toggle");if(g&&Q){let t=()=>{g.classList.toggle("canvas-sidebar-open")};Q.addEventListener("click",t),v.push(()=>{Q.removeEventListener("click",t)})}let ee=n.querySelector(".canvas-zoom-in"),te=n.querySelector(".canvas-zoom-out"),Ee=t=>{let r=n.getBoundingClientRect();j(t,r.width/2,r.height/2)};if(v.push(()=>{d&&cancelAnimationFrame(d),b()}),ee){let t=()=>{Ee(1.25)};ee.addEventListener("click",t),v.push(()=>ee.removeEventListener("click",t))}if(te){let t=()=>{Ee(.8)};te.addEventListener("click",t),v.push(()=>te.removeEventListener("click",t))}if(I){let t=()=>{J(C,A,O)};I.addEventListener("click",t),v.push(()=>I.removeEventListener("click",t))}let B=n.querySelector(".canvas-fullscreen-toggle");if(B){let t=B.querySelector(".canvas-fullscreen-enter"),r=B.querySelector(".canvas-fullscreen-exit"),l=()=>{let h=document.fullscreenElement===n;t&&(t.style.display=h?"none":""),r&&(r.style.display=h?"":"none")},w=()=>{document.fullscreenElement===n?document.exitFullscreen():n.requestFullscreen()},F=()=>{l(),requestAnimationFrame(()=>{$(),C=s,A=c,O=i,L()})};B.addEventListener("click",w),document.addEventListener("fullscreenchange",F),v.push(()=>{B.removeEventListener("click",w),document.removeEventListener("fullscreenchange",F)})}let Be=n.querySelectorAll(".canvas-iframe-wrapper iframe");for(let t of Array.from(Be))t.addEventListener("error",()=>{let r=t.parentElement?.querySelector(".canvas-iframe-fallback");r&&(t.style.display="none",r.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let t of v)t();n.dataset.initialized="false"})}}if(typeof document<"u"){let Y=()=>{xe()};document.addEventListener("nav",Y),document.addEventListener("render",Y)}\n';
var l;
