...
var canvas_inline_default = 'function Le(){let b=document.querySelectorAll(".canvas-container");if(b.length!==0)for(let t of Array.from(b)){if(t.dataset.initialized==="true")continue;t.dataset.initialized="true";let Y=t.querySelector(".canvas-viewport");if(!Y)continue;let de=t.dataset.enableInteraction!=="false",fe=t.dataset.defaultFullscreen==="true",v=t.closest(\'.page[data-frame="canvas"]\'),me=window.matchMedia("(max-width: 800px)").matches;v&&!fe&&!me&&(v.classList.add("canvas-init-no-transition","canvas-sidebar-open"),v.offsetWidth,requestAnimationFrame(()=>{v.classList.remove("canvas-init-no-transition")}));let O=parseFloat(t.dataset.minZoom??"")||.1,W=parseFloat(t.dataset.maxZoom??"")||5,ve=parseFloat(t.dataset.initialZoom??"")||1,s=1,f=s,q=0,x=0,m=0,i=0,c=0,S=!1,N=0,V=0,L=()=>{Y.style.transform=`translate(${i}px, ${c}px) scale(${s})`},$=.9,G=()=>{let n=t.getBoundingClientRect(),r=parseFloat(Y.style.width)||1e3,l=parseFloat(Y.style.height)||1e3,M=n.width/r*$,T=n.height/l*$,u=Math.min(M,T,1)*ve;return u=Math.max(O,Math.min(W,u)),{zoom:u,panX:(n.width-r*u)/2,panY:(n.height-l*u)/2}},X=()=>{let n=G();s=n.zoom,i=n.panX,c=n.panY,f=s,m&&(cancelAnimationFrame(m),m=0),L()};X();let F=s,I=i,Z=c,w=t.querySelector(".canvas-reset-view"),K=()=>Math.abs(s-F)<=.001&&Math.abs(i-I)<=1&&Math.abs(c-Z)<=1,h=()=>{w&&(w.style.display=K()?"none":"flex")},he=.2,U=()=>{let n=s;s+=(f-s)*he,Math.abs(f-s)<5e-4&&(s=f),i=q-(q-i)*(s/n),c=x-(x-c)*(s/n),L(),h(),m=s===f?0:requestAnimationFrame(U)},A=(n,r,l)=>{f=Math.max(O,Math.min(W,f*n)),q=r,x=l,m||(m=requestAnimationFrame(U))},d=[],p=t.getBoundingClientRect(),pe=()=>{let n=t.getBoundingClientRect();if(n.left===p.left&&n.top===p.top&&n.width===p.width&&n.height===p.height)return;let r=K();i-=n.left-p.left,c-=n.top-p.top,p=n;let l=G();F=l.zoom,I=l.panX,Z=l.panY,r?X():L(),h()},j=new ResizeObserver(pe);if(j.observe(t),d.push(()=>j.disconnect()),de){let l=e=>e.deltaMode!==0?e.deltaY>0?.7692307692307692:1.3:Math.exp(-e.deltaY*.004),M=e=>e.deltaMode!==0?!1:e.deltaX!==0||!Number.isInteger(e.deltaY)?!0:Math.abs(e.deltaY)<40,T=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?e.scrollWidth>e.clientWidth:e.scrollHeight>e.clientHeight,u=(e,o)=>Math.abs(o.deltaX)>Math.abs(o.deltaY)?!(e.scrollWidth<=e.clientWidth||e.scrollLeft<=0&&o.deltaX<0||e.scrollLeft+e.clientWidth>=e.scrollWidth-1&&o.deltaX>0):!(e.scrollHeight<=e.clientHeight||e.scrollTop<=0&&o.deltaY<0||e.scrollTop+e.clientHeight>=e.scrollHeight-1&&o.deltaY>0),Q=e=>{let o=t.getBoundingClientRect(),a=e.clientX-o.left,E=e.clientY-o.top;if(e.ctrlKey||e.metaKey){e.preventDefault(),A(l(e),a,E);return}let y=e.target instanceof HTMLElement?e.target.closest(".canvas-node:not(.canvas-node-group)"):null;if(y){let g=y.querySelector(".canvas-node-content");if(g instanceof HTMLElement&&T(g,e)){if(u(g,e))return;e.preventDefault();return}}e.preventDefault(),M(e)?(i-=e.deltaX,c-=e.deltaY,L(),h()):A(l(e),a,E)},ee=e=>{let o=e.button===1;if(!(e.button!==0&&!o)){if(o)e.preventDefault();else if(e.target instanceof HTMLElement){if(e.target.closest("a")||e.target.closest("button"))return;let a=e.target.closest(".canvas-node-content");if(a&&a.scrollHeight>a.clientHeight){let E=a.getBoundingClientRect();if(e.clientX>=E.right-16)return}}S=!0,N=e.clientX-i,V=e.clientY-c,t.style.cursor="grabbing",t.setPointerCapture(e.pointerId)}},te=e=>{S&&(i=e.clientX-N,c=e.clientY-V,L(),h())},z=()=>{S=!1,t.style.cursor=""},ne=e=>e.preventDefault();t.addEventListener("wheel",Q,{passive:!1}),t.addEventListener("pointerdown",ee),t.addEventListener("pointermove",te),t.addEventListener("pointerup",z),t.addEventListener("pointercancel",z),t.addEventListener("dragstart",ne);let R=0,k=0,P=0,_=!1,oe=e=>{if(e.length<2||!e[0]||!e[1])return 0;let o=e[0].clientX-e[1].clientX,a=e[0].clientY-e[1].clientY;return Math.sqrt(o*o+a*a)},se=e=>{if(e.touches.length===2){let o=e.touches[0],a=e.touches[1];if(!o||!a)return;e.preventDefault(),_=!0,S=!1,R=oe(e.touches),k=(o.clientX+a.clientX)/2,P=(o.clientY+a.clientY)/2}},ae=e=>{if(e.touches.length===2&&_){let o=e.touches[0],a=e.touches[1];if(!o||!a)return;e.preventDefault();let E=oe(e.touches),y=(o.clientX+a.clientX)/2,g=(o.clientY+a.clientY)/2,ie=t.getBoundingClientRect(),ce=y-ie.left,le=g-ie.top,ge=E/R,ue=s;s=Math.max(O,Math.min(W,s*ge)),f=s,i=ce-(ce-i)*(s/ue),c=le-(le-c)*(s/ue),i+=y-k,c+=g-P,R=E,k=y,P=g,L(),h()}},re=e=>{e.touches.length<2&&(_=!1)};t.addEventListener("touchstart",se,{passive:!1}),t.addEventListener("touchmove",ae,{passive:!1}),t.addEventListener("touchend",re),d.push(()=>{t.removeEventListener("wheel",Q),t.removeEventListener("pointerdown",ee),t.removeEventListener("pointermove",te),t.removeEventListener("pointerup",z),t.removeEventListener("pointercancel",z),t.removeEventListener("dragstart",ne),t.removeEventListener("touchstart",se),t.removeEventListener("touchmove",ae),t.removeEventListener("touchend",re)})}let B=v?.querySelector(".canvas-sidebar-toggle");if(v&&B){let n=()=>{v.classList.toggle("canvas-sidebar-open")};B.addEventListener("click",n),d.push(()=>{B.removeEventListener("click",n)})}let C=t.querySelector(".canvas-zoom-in"),D=t.querySelector(".canvas-zoom-out"),J=n=>{let r=t.getBoundingClientRect();A(n,r.width/2,r.height/2)};if(d.push(()=>{m&&cancelAnimationFrame(m)}),C){let n=()=>{J(1.25)};C.addEventListener("click",n),d.push(()=>C.removeEventListener("click",n))}if(D){let n=()=>{J(.8)};D.addEventListener("click",n),d.push(()=>D.removeEventListener("click",n))}if(w){let n=()=>{X(),F=s,I=i,Z=c,h()};w.addEventListener("click",n),d.push(()=>w.removeEventListener("click",n))}let H=t.querySelector(".canvas-fullscreen-toggle");if(H){let n=H.querySelector(".canvas-fullscreen-enter"),r=H.querySelector(".canvas-fullscreen-exit"),l=()=>{let u=document.fullscreenElement===t;n&&(n.style.display=u?"none":""),r&&(r.style.display=u?"":"none")},M=()=>{document.fullscreenElement===t?document.exitFullscreen():t.requestFullscreen()},T=()=>{l(),requestAnimationFrame(()=>{X(),F=s,I=i,Z=c,h()})};H.addEventListener("click",M),document.addEventListener("fullscreenchange",T),d.push(()=>{H.removeEventListener("click",M),document.removeEventListener("fullscreenchange",T)})}let Ee=t.querySelectorAll(".canvas-iframe-wrapper iframe");for(let n of Array.from(Ee))n.addEventListener("error",()=>{let r=n.parentElement?.querySelector(".canvas-iframe-fallback");r&&(n.style.display="none",r.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let n of d)n();t.dataset.initialized="false"})}}if(typeof document<"u"){let b=()=>{Le()};document.addEventListener("nav",b),document.addEventListener("render",b)}\n';
var l;
